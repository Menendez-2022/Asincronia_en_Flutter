...
import 'package:asyncawait/services/mockapi.dart';
import 'package:flutter/services.dart';

class AsynScreen extends StatefulWidget {
  const AsynScreen({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _AsynScreenState createState() => _AsynScreenState();
}

class _AsynScreenState extends State<AsynScreen> with TickerProviderStateMixin {
